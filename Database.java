    ...
    public static void saveUsersToXML(List<User> users, String filePath) {
        ...
        try {
            ...
            for (User user : users) {
                ...
                userElement.appendChild(createElement(doc, "WeightKg", String.valueOf(user.weightKg())));
...
// test main for pushing data to the files, prove it works and files exist in test cases
    public static void main(String[] args) {
        ...
        Database.saveCalcMacrosToXML(alice, totalCalories, alice.goal(), aliceMacros, alice.getUserName()+"macroGoals.xml");
        Database.saveCalcMacrosToXML(bob, totalCalories, bob.goal(), bobMacros, bob.getUserName()+"macroGoals.xml");
